...
{
	 ?>
	 <p> <?php //echo "$_SESSION[Username]"?> LOGGED IN</p>
...
else
{
   ...
   <p>Thanks for visiting! Please either login below, or <a href="ruetcafeteria_files/register.php">click here to register</a>.</p>
	<form method="post" action="./index.php" name="loginform" id="loginform" class="loginbo" onsubmit ="return validateForm()" >
		...
		<input type="submit" name="login" id="login" value="Login"  onclick="parent.location='form.html'"/>
