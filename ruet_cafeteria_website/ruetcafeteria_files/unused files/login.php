...
if(!empty($_SESSION['LoggedIn']) && !empty($_SESSION['Username']))
{
	 ...
	 <p align="center">You are already logged in  <b> Mr.<?php echo "$_SESSION[Username]"?></b> <a href="index.php">Click here</a> to order </p>
...
elseif(!empty($_POST['username']) && !empty($_POST['password']))
{
    ...
    if(mysql_num_rows($checklogin) == 1)
    {
        ...
        echo "<meta http-equiv='refresh' content='=2;service.php' />";
    }
    else
    {
    	echo "<h1>Error</h1>";
...
else
{
   ...
   <p>Thanks for visiting! Please either login below, or <a href="register.php">click here to register</a>.</p>
	...
	<form method="post" action="service.php" name="loginform" id="loginform">
	<fieldset>
